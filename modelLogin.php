<?php
	...
	public function CheckIfUsernameIsAvailable($username){
		$connection = mysqli_connect("mikaeledberg.se.mysql", "mikaeledberg_se", "ee8w7zQD", "mikaeledberg_se");
	...
	public function Save($newUsername, $newPassword){
    	...
    	mysqli_query($connection,"INSERT Users SET Username = '$newUsername', Password = '$newPassword'");
